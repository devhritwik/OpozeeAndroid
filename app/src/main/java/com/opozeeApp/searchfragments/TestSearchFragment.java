...
public class TestSearchFragment extends Fragment implements PostedQuestionsView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("TESTFRAGMENT", "onCreateView6");
...
//        recyclerView.clearOnScrollListeners();
    ...
    private void getQuestions() {
        ...
        if (HomeNewFragment.getTagsModelist.size() >= 6) {
            params.setSearchtext(HomeNewFragment.getTagsModelist.get(5).getHashtag());
        }else{
