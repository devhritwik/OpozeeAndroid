...
public class CountSearchFragment extends Fragment implements PostedQuestionsView {
...
//        Log.d("TESTFRAGMENT", "onCreateView2");
...
//        recyclerView.clearOnScrollListeners();
    ...
    private void getQuestions() {
        ...
        if (HomeNewFragment.getTagsModelist.size() >=2) {
            params.setSearchtext(HomeNewFragment.getTagsModelist.get(1).getHashtag());
        }else{
