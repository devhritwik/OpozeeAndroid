...
public class QuestionFragment extends Fragment implements PostedQuestionsView {
...
//        Log.d("TESTFRAGMENT", "onCreateView5");
...
//        recyclerView.clearOnScrollListeners();
    ...
    private void getQuestions() {
        ...
        if (HomeNewFragment.getTagsModelist.size() >= 5) {
            params.setSearchtext(HomeNewFragment.getTagsModelist.get(4).getHashtag());
        }else{
