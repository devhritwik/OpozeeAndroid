...
public class AndroidEmoji {
	...
	/**
	 * Span to set on TextView instances in order to have a custom fonts for single parts of a text
	 * 
	 * <pre>
	...
	/**
	 * Manages the reference to the emoji fonts
	 * <p>
	...
	/**
	 * Ensures that all emoji in the given string will be displayed correctly by modifying the fonts for single symbols
	 * 
	...
	public static CharSequence ensure(String input, final Context context) {
		...
		// create a SpannableStringBuilder instance where the fonts ranges will be set for emoji characters
		...
		for (int i = 0; i < chars.length; i++) {
			...
			if (isEmoji(codePoint)) {
				// change the fonts for this symbol (two characters if surrogate pair) to the emoji fonts
