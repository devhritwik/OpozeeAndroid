...
import com.opozee.emojilike.ActivityWithEmoji;
import com.opozee.emojilike.Emoji;
import com.opozee.emojilike.EmojiException;
...
public class EmojiConfig
{
    ...
    private EmojiConfig(com.opozee.emojilike.IActivityWithEmoji target)
    {
        this.target = target;
        touchDownDelay=0;
        touchUpDelay=0;
