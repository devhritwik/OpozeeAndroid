...
public class ViewWeightAnimation extends Animation
{
    ...
    public ViewWeightAnimation(Context context, GifImageView view, int index, float initWeight, float maxWeight, float step, boolean forSelected, EmojiConfig config)
    {
