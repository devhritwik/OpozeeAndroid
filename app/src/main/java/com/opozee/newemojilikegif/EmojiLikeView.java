...
import com.opozee.newemojilikegif.ViewWeightAnimation;
...
public class EmojiLikeView extends RelativeLayout
{
    ...
    public void configure (EmojiConfig config)
    {
        ...
        if (config.backgroundImageResource !=0)
        {
            ...
            LayoutParams params=new LayoutParams(LayoutParams.MATCH_PARENT, config.backgroundViewHeight);
        ...
        LayoutParams params=new LayoutParams(LayoutParams.MATCH_PARENT, config.emojiImagesContainerHeight);
        params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
