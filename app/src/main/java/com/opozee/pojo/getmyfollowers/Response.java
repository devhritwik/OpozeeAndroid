...
public class Response
{
    ...
    public List<com.opozee.pojo.getmyfollowers.GetMyFollowers> getGetMyFollowers() {
        return GetMyFollowers;
    }

    public void setGetMyFollowers(List<com.opozee.pojo.getmyfollowers.GetMyFollowers> getMyFollowers) {
